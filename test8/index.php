  ...
  <body>
	...
	<div class="col-6 mx-auto" > <!--ГЛАВНЫЙ БЛОК-->
		<div class="col-12">
			...
			<input type="" name="gk1" placeholder="id" class="col-12 text-center" style="height: 50px;">	
			<input type="" name="gl1" placeholder="text" class="col-12 text-center" style="height: 50px;">
			<input type="" name="gh1" placeholder="img" class="col-12 mt-2 text-center" style="height: 50px;">
